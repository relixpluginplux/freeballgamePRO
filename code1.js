...
gdjs.TutorialCode.asyncCallback12598244 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.TutorialCode.asyncCallback12598244(runtimeScene, asyncObjectsList)));
}
}
...
{
{gdjs.TutorialCode.conditionTrue_1 = gdjs.TutorialCode.condition0IsTrue_0;
gdjs.TutorialCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(12936148);
}
}if (gdjs.TutorialCode.condition0IsTrue_0.val) {
